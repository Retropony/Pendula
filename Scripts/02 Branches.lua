...
function SelectMusicOrCourse()
	...
	elseif GAMESTATE:IsCourseMode() then
		return Branch.CoursePhase()
	else
		return Branch.MusicPhase()
	end
end
...
Branch = {
	...
	ArcadeStart = function()
		if GAMESTATE:GetCoinMode() == "CoinMode_Home" then
			return Branch.TitleMenuPhase()
		else
	...
	TitleMenuPhase = function()
		if Future() == 'true' then
			return "ScreenFutureTitleMenu"
		else
			return "ScreenTitleMenu"
		end
	end,
	TitleJoinPhase = function()
		if Future() == 'true' then
			return "ScreenFutureTitleJoin"
		else
	...
	TitleMenu = function()
		...
		elseif GAMESTATE:GetCoinMode() == "CoinMode_Home" then
			return Branch.TitleMenuPhase()
		-- arcade junk:
		elseif GAMESTATE:GetCoinsNeededToJoin() > GAMESTATE:GetCoins() then
	...
	MusicPhase = function()
		if Future() == 'true' then
			return "ScreenFutureSelectMusic"
		else
			return "ScreenSelectMusic"
		end
	end,
	CoursePhase = function()
		if Future() == 'true' then
			return "ScreenFutureSelectCourse"
		else
	...
	Network = function()
		return IsNetConnected() and "ScreenNetTitleMenu" or Branch.TitleMenuPhase()
	end,
