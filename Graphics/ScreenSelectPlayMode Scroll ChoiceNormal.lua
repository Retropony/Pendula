local t = Def.ActorFrame{};
	...
	t[#t+1] = LoadActor("_clock-selection")..{
		...
		GainFocusCommand=cmd(linear,0.1;diffuse,color("#f78b00"));
	...
	t[#t+1] = LoadActor(THEME:GetPathG("","_pointer/i-common") )..{
		InitCommand=cmd(zoom,0.75;diffusealpha,0;diffuse,color("#f78b00"));
	...
	t[#t+1] = LoadActor(THEME:GetPathG("","_mode/o-standard") )..{
		InitCommand=cmd(zoom,0.75);
	};
	t[#t+1] = LoadActor(THEME:GetPathG("","_mode/i-standard") )..{
